...
from .managers import GeneratedAudioManager, ChatHistoryManager, AvatarManager
...
class ChatHistory(models.Model):
    ...
    chat = models.TextField() # NOTE: should be a json with key value pair of sender type and message
    # sender_type = models.CharField(max_length=10, choices=SenderTypeChoices)
    status = models.CharField(max_length=10, choices=StatusChoices, default=StatusChoices.ACTIVE)
